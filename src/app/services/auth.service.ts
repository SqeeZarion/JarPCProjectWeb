...
export class AuthService {
  ...
  private baseUrl:string ="http://localhost:5089/api/Auth/"
  private baseUrl1:string ="http://localhost:5089/api/Message/"
  private baseUrl2:string ="http://localhost:5089/api/admin/"
